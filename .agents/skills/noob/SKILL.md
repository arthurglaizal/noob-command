---
name: noob
description: Re-explain the assistant's most recent answer in a simpler, easier-to-understand, and more concise way, without taking action or changing anything. Use only when the user explicitly invokes `$noob`.
---
